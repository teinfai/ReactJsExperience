...
// wevetel
import Wevechat from "../Components/Application/Wevetel/ChatApp";
import Weveprofile from "../Components/Application/Wevetel/Profile/UsersProfile";
import Weveeditprofile from "../Components/Application/Wevetel/Profile/UsersEdit";
// import Wevecontact from "../Components/Application/Wevetel/Contact/ContactApp";
import NewFax from "../Components/Application/Wevetel/Email/MailInbox";
import Wevedashboard from "../Components/Application/Wevetel/Dashboard";
import PhoneBook from "../Components/Application/Wevetel/PhoneBook";
import Fax from "../Components/Application/Wevetel/Fax";
...
export const routes = [
  //wevetel
  { path: `${process.env.PUBLIC_URL}/wevetel/chat/:layout`, Component: <Wevechat /> },
  { path: `${process.env.PUBLIC_URL}/wevetel/profile/:layout`, Component: <Weveprofile /> },
  { path: `${process.env.PUBLIC_URL}/wevetel/edit_profile/:layout`, Component: <Weveeditprofile /> },
  // { path: `${process.env.PUBLIC_URL}/wevetel/contact/:layout`, Component: <Wevecontact /> },
  { path: `${process.env.PUBLIC_URL}/wevetel/PhoneBook/:layout`, Component: <PhoneBook /> },

  { path: `${process.env.PUBLIC_URL}/wevetel/newfax/:layout`, Component: <NewFax /> },

  { path: `${process.env.PUBLIC_URL}/wevetel/dashboard/:layout`, Component: <Wevedashboard /> },
  { path: `${process.env.PUBLIC_URL}/wevetel/Fax/:layout`, Component: <Fax /> },

  //dashboard
  // { path: `${process.env.PUBLIC_URL}/testing/:layout`, Component: <Test /> },
