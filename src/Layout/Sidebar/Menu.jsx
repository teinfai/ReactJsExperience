export const MENUITEMS = [
    ...
    Items: [
      {
        ...
        // badgetxt: "5",
        active: false,
        path: `${process.env.PUBLIC_URL}/wevetel/dashboard`, title: "Dashboard", type: "link",
      },
      {
        title: "PhoneBook",
        icon: "contact",
        ...
        // badgetxt: "5",
        active: false,
        path: `${process.env.PUBLIC_URL}/wevetel/phonebook`, title: "PhoneBook", type: "link",
      },

      {
        ...
        // badgetxt: "5",
        active: false,
        path: `${process.env.PUBLIC_URL}/wevetel/chat`, title: "Chat", type: "link",
      },

      // hide for now, not yet done
      ...
      //   active: false,
      //   children: [
      //     { path: `${process.env.PUBLIC_URL}/wevetel/profile`, type: "link", title: "User Profile" },
      //     { path: `${process.env.PUBLIC_URL}/wevetel/edit_profile`, type: "link", title: "User Edit" },
      //   ],
      // },
      // {
      //   title: "Contact",
      ...
      //   // bookmark: true,
      //   active: false,
      //   path: `${process.env.PUBLIC_URL}/wevetel/contact`, title: "Contact", type: "link",
      // },
      ...
      // hide for now, not yet done
      {
        ...
        // bookmark: true,
        active: false,
        path: `${process.env.PUBLIC_URL}/wevetel/fax`, title: "Fax", type: "link",
        // children: [
        //   { path: `${process.env.PUBLIC_URL}/wevetel/newfax`, title: "inbox", type: "link" },
        // ],
      },
    ],
  },
  ...
  // {
  //   menutitle: "Components",http://localhost:3000/wevetel/phonebook/wevo
