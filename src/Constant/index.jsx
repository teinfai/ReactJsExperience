...
export const DomainNamelabel = "Domain Name";
...
//Custom 
// Fax
export const Fax = "Send Fax";
export const FaxHeader = "Fax Header";
export const LocalStationIdentifier = "Local Station Identifier";
export const FaxDestination = "Fax Destination";
export const InvalidEmailAddress = "Invalid email address";
export const InvalidFileType = "Invalid file type";
export const InputEmpty = "Please Fill In the field";
export const FaxInstruction = "All fields are required; kindly complete all mandatory fields.";
